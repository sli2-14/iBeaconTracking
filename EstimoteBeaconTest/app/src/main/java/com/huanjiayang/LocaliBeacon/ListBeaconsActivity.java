...
//        getActionBar().setDisplayHomeAsUpEnabled(true);
            ...
            public void onBeaconsDiscovered(Region region, final List<Beacon> beacons) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        setStatusText("Number of iBeacons found: " + beacons.size());
                        ...
                        Log.i("estimode_Loc_info", locText);
                        setLocText(locText);
                    }
                });
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_ENABLE_BT) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                setStatusText("Bluetooth not enabled");
            }
        }
    ...
    private void setStatusText(String msg){
        ((TextView)findViewById(R.id.estimode_list_beacon_status)).setText(msg);
    }

    private void setLocText(String msg){
        ((TextView)findViewById(R.id.estimode_loc_beacons)).setText(msg);
    }
